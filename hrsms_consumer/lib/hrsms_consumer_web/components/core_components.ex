defmodule HrsmsConsumerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HrsmsConsumerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HrsmsConsumerWeb.Gettext, "errors", msg, opts)
    end
  end
