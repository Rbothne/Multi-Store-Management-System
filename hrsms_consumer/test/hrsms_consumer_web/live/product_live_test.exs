defmodule HrsmsConsumerWeb.ProductLiveTest do
  use HrsmsConsumerWeb.ConnCase

  import Phoenix.LiveViewTest
  import HrsmsConsumer.BusinessFixtures

  @create_attrs %{inventory: 42, product_name: "some product_name", retail: 42, vendor_name: "some vendor_name", wholesale: 42}
