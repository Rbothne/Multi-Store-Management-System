defmodule HrsmsWeb.EmployeeControllerTest do
  use HrsmsWeb.ConnCase

  import Hrsms.HumanResourcesFixtures

  @create_attrs %{date_of_hire: ~D[2023-04-27], department: "some department", emp: 42, first_name: "some first_name", last_name: "some last_name"}
